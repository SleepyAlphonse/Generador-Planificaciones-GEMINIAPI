...
// Objetivos de Aprendizaje transcritos LITERALMENTE de las Bases Curriculares de la Educación Parvularia 2018 (MINEDUC).
// No editar la redacción: debe mantenerse idéntica al documento oficial.
const OAS = {
  comunicacion: { label:"Comunicación Integral", nucleos: {
    lenguaje_verbal: { label:"Lenguaje Verbal",
      sala_cuna:["OA1: Expresar oralmente sus emociones y necesidades, a través de balbuceos, vocalizaciones y diversos recursos gestuales.","OA2: Expresar oralmente sus necesidades e intereses, mediante la combinación de palabras y gestos, el uso de palabra-frase y progresivamente el empleo de frases simples.","OA3: Identificar progresivamente la intención comunicativa de las distintas personas de su entorno a partir de sus expresiones verbales, no verbales y paraverbales.","OA4: Comprender mensajes simples y breves en juegos y situaciones comunicativas cotidianas, respondiendo en forma gestual y corporal.","OA5: Reconocer sonidos de diferentes fuentes sonoras de su entorno cotidiano, tales como objetos, artefactos, instrumentos musicales, animales, naturaleza.","OA6: Incorporar nuevas palabras a su repertorio lingüístico para comunicarse con otros, en juegos y conversaciones.","OA7: Disfrutar de distintos textos gráficos (libros de cuentos, láminas, entre otros) al manipularlos y observar sus imágenes.","OA8: Comprender progresivamente, a partir de la escucha atenta, algunos contenidos explícitos de textos literarios y no literarios, respondiendo preguntas simples, en forma oral o gestual (¿qué es?, ¿quién es?, ¿dónde está?)."],
      medio:["OA1: Expresarse oralmente, empleando estructuras oracionales simples y respetando patrones gramaticales básicos, en distintas situaciones cotidianas y juegos.","OA2: Comprender mensajes simples como instrucciones explícitas, explicaciones y preguntas relativas a objetos, personas, acciones, tiempo y lugar, identificando la intencionalidad comunicativa de diversos interlocutores.","OA3: Identificar algunos atributos de los sonidos de diferentes fuentes sonoras como intensidad (fuerte/suave), velocidad (rápido/lento).","OA4: Incorporar progresivamente nuevas palabras, al comunicar oralmente temas variados de su interés e información básica, en distintas situaciones cotidianas.","OA5: Manifestar interés por descubrir el contenido de textos de diferentes formatos, a través de la manipulación, la exploración, la escucha atenta y la formulación de preguntas.","OA6: Comprender a partir de la escucha atenta, contenidos explícitos de textos literarios y no literarios, reconociendo ideas centrales, señalando preferencias, realizando sencillas descripciones, preguntando sobre el contenido.","OA7: Reconocer progresivamente el significado de diversas imágenes, logos, símbolos de su entorno cotidiano, en diversos soportes (incluye uso de TICs).","OA8: Producir sus propios signos gráficos en situaciones lúdicas."],
      transicion:["OA1: Expresarse oralmente en forma clara y comprensible, empleando estructuras oracionales completas, conjugaciones verbales adecuadas y precisas con los tiempos, personas e intenciones comunicativas.","OA2: Comprender textos orales como preguntas, explicaciones, relatos, instrucciones y algunos conceptos abstractos en distintas situaciones comunicativas, identificando la intencionalidad comunicativa de diversos interlocutores.","OA3: Descubrir en contextos lúdicos, atributos fonológicos de palabras conocidas, tales como conteo de palabras, segmentación y conteo de sílabas, identificación de sonidos finales e iniciales.","OA4: Comunicar oralmente temas de su interés, empleando un vocabulario variado e incorporando palabras nuevas y pertinentes a las distintas situaciones comunicativas e interlocutores.","OA5: Manifestar interés por descubrir el contenido y algunos propósitos de diferentes textos escritos (manipulando, explorando, realizando descripciones y conjeturas) a través del contacto cotidiano con algunos de ellos, o del uso de TICs.","OA6: Comprender contenidos explícitos de textos literarios y no literarios, a partir de la escucha atenta, describiendo información y realizando progresivamente inferencias y predicciones.","OA7: Reconocer palabras que se encuentran en diversos soportes asociando algunos fonemas a sus correspondientes grafemas.","OA8: Representar gráficamente algunos trazos, letras, signos, palabras significativas y mensajes simples legibles, utilizando diferentes recursos y soportes en situaciones auténticas.","OA9: Comunicar mensajes simples en la lengua indígena pertinente a la comunidad donde habita.","OA10: Reconocer algunas palabras o mensajes sencillos de lenguas maternas de sus pares, distintas al castellano."],
    },
    lenguajes_artisticos: { label:"Lenguajes Artísticos",
      sala_cuna:["OA1: Manifestar interés por los sonidos, las texturas, los colores y la luminosidad de su entorno, respondiendo a través de diversas formas, tales como balbuceo, gestos, sonrisas, entre otros.","OA2: Producir sonidos con su voz, su cuerpo y diversos objetos sonoros, en forma espontánea o por imitación.","OA3: Imitar gestos, movimientos, sonidos de su entorno significativo, a través de diversos medios.","OA4: Manifestar sus preferencias por recursos expresivos presentes en piezas musicales, visuales, y escénicas, a través de gestos, movimientos, palabras, entre otros.","OA5: Expresar corporalmente las emociones y sensaciones que le provocan algunas piezas musicales, bailando, cantando e intentando seguir el ritmo.","OA6: Experimentar sus posibilidades de expresión plástica a través de diversos recursos, produciendo sus primeros garabateos espontáneos."],
      medio:["OA1: Manifestar interés por diversas producciones artísticas (arquitectura, modelado, piezas musicales, pintura, dibujos, títeres, obras de teatro, danzas, entre otras), describiendo algunas características.","OA2: Expresar sus preferencias, sensaciones y emociones relacionadas con diferentes recursos expresivos que se encuentran en sencillas obras visuales (colorido, formas), musicales (fuente, intensidad del sonido) o escénicas (desplazamiento, vestimenta, carácter expresivo).","OA3: Interpretar canciones y juegos musicales, experimentando con diversos recursos tales como, la voz, el cuerpo, instrumentos musicales y objetos.","OA4: Expresar corporalmente sensaciones y emociones experimentando con mímica, juegos teatrales, rondas, bailes y danzas.","OA5: Expresar emociones, ideas y experiencias por medio de la plástica experimentando con recursos pictóricos, gráficos y de modelado.","OA6: Experimentar diversas posibilidades de expresión, combinando lenguajes artísticos en sus producciones.","OA7: Representar a través del dibujo, diversos elementos de su entorno, incorporando figuras cerradas, trazos intencionados y primeros esbozos de la figura humana."],
      transicion:["OA1: Apreciar producciones artísticas de diversos contextos (en forma directa o a través de medios tecnológicos), describiendo y comparando algunas características visuales, musicales o escénicas (desplazamiento, ritmo, carácter expresivo, colorido, formas, diseño, entre otros).","OA2: Comunicar sus impresiones, emociones e ideas respecto de diversas obras de arte, producciones propias y de sus pares (artesanías, piezas musicales, obras plásticas y escénicas, entre otras).","OA3: Interpretar canciones y juegos musicales, utilizando de manera integrada diversos recursos tales como, la voz, el cuerpo, instrumentos musicales y objetos.","OA4: Expresar corporalmente sensaciones, emociones e ideas a partir de la improvisación de escenas dramáticas, juegos teatrales, mímica y danza.","OA5: Representar plásticamente emociones, ideas, experiencias e intereses, a través de líneas, formas, colores, texturas, con recursos y soportes en plano y volumen.","OA6: Experimentar diversas combinaciones de expresión plástica, corporal y musical, comunicando las razones del proceso realizado.","OA7: Representar a través del dibujo, sus ideas, intereses y experiencias, incorporando detalles a las figuras humanas y a objetos de su entorno, ubicándolos en parámetros básicos de organización espacial (arriba/abajo, dentro/fuera)."],
    },
  }},
  desarrollo: { label:"Desarrollo Personal y Social", nucleos: {
    identidad: { label:"Identidad y Autonomía",
      sala_cuna:["OA1: Expresar vocal, gestual o corporalmente distintas necesidades o emociones (alegría, miedo, pena, entre otras).","OA2: Manifestar satisfacción cuando percibe que adultos significativos le expresan afecto.","OA3: Reconocer algunas emociones en adultos significativos, reaccionando frente a ellas.","OA4: Manifestar sus preferencias por algunas situaciones, objetos y juegos.","OA5: Manifestar interés por nuevas situaciones u objetos, ampliando su campo y repertorio de acción habitual.","OA6: Reconocer algunos rasgos distintivos de su identidad, tales como: su nombre y su imagen física en el espejo.","OA7: Incorporar rutinas básicas vinculadas a la alimentación, vigilia, sueño, higiene, y vestuario dentro de un contexto diferente a su hogar y sensible a sus necesidades personales."],
      medio:["OA1: Representar verbal y corporalmente diferentes emociones y sentimientos, en sus juegos.","OA2: Manifestar disposición y confianza al separarse de los adultos significativos.","OA3: Reconocer en sí mismo, en otras personas y en personajes de cuentos, emociones tales como: tristeza, miedo, alegría, pena y rabia.","OA4: Manifestar disposición para regular sus emociones y sentimientos, en función de las necesidades propias, de los demás y de algunos acuerdos para el funcionamiento grupal.","OA5: Manifestar sus preferencias cuando participa o cuando solicita participar, en diversas situaciones cotidianas y juegos.","OA6: Actuar con progresiva independencia, ampliando su repertorio de acciones, acorde a sus necesidades e intereses.","OA7: Comunicar algunos rasgos de su identidad, como su nombre, sus características corporales, género y otros.","OA8: Apreciar sus características identitarias, fortalezas y habilidades.","OA9: Manifestar progresiva independencia en sus prácticas de alimentación, vigilia y sueño, vestimenta, higiene corporal, bucal y evacuación.","OA10: Manifestar satisfacción y confianza por su autovalía, comunicando algunos desafíos alcanzados, tales como: saltar, hacer torres, sacar cáscara de huevos, entre otros.","OA11: Identificar alimentos que se consumen en algunas celebraciones propias de su familia y comunidad.","OA12: Representar sus pensamientos y experiencias, atribuyendo significados a objetos o elementos de su entorno, usando la imaginación en situaciones de juego."],
      transicion:["OA1: Comunicar a los demás, emociones y sentimientos tales como: amor, miedo, alegría, ira, que le provocan diversas narraciones o situaciones observadas en forma directa o a través de TICs.","OA2: Manifestar disposición y confianza para relacionarse con algunos adultos y pares que no son parte del grupo o curso.","OA3: Reconocer emociones y sentimientos en otras personas, observadas en forma directa o a través de TICs.","OA4: Expresar sus emociones y sentimientos autorregulándose en función de las necesidades propias, de los demás y las normas de funcionamiento grupal.","OA5: Comunicar sus preferencias, opiniones, ideas, en diversas situaciones cotidianas y juegos.","OA6: Planificar proyectos y juegos, en función de sus ideas e intereses, proponiendo actividades, organizando los recursos, incorporando los ajustes necesarios e iniciándose en la apreciación de sus resultados.","OA7: Comunicar rasgos de su identidad de género, roles (nieta/o, vecino/a, entre otros), sentido de pertenencia y cualidades personales.","OA8: Comunicar sus características identitarias, fortalezas, habilidades y desafíos personales.","OA9: Cuidar su bienestar personal, llevando a cabo sus prácticas de higiene, alimentación y vestuario, con independencia y progresiva responsabilidad.","OA10: Comunicar a otras personas desafíos alcanzados, identificando acciones que aportaron a su logro y definiendo nuevas metas.","OA11: Distinguir parámetros establecidos para la regulación de alimentos, tales como: etiquetado de sellos, fechas de vencimiento, entre otros.","OA12: Anticipar acciones y prever algunas situaciones o desafíos que se pueden presentar, en juegos, proyectos, sucesos que experimenta o que observa a través de TICs.","OA13: Representar en juegos sociodramáticos, sus pensamientos y experiencias atribuyendo significados a objetos, personas y situaciones."],
    },
    convivencia: { label:"Convivencia y Ciudadanía",
      sala_cuna:["OA1: Interactuar con pares y adultos significativos (a través de gestos y vocalizaciones, entre otros), en diferentes situaciones y juegos.","OA2: Disfrutar de la cercanía de niños, niñas y adultos en juegos y situaciones cotidianas.","OA3: Manifestar interés por lo que le sucede a otros niños y niñas, a través de acciones tales como: abrazar a quien está llorando, hacer cariños, entre otros.","OA4: Manifestar interés por participar en celebraciones de su entorno significativo.","OA5: Practicar algunas normas de convivencia, tales como: sentarse en su silla para almorzar, saludar, despedirse, y colaborar en acciones cotidianas.","OA6: Manifestar disposición para responder positivamente o cambiar su comportamiento, frente a requerimientos del adulto, asociados a su seguridad y bienestar."],
      medio:["OA1: Participar en actividades y juegos grupales con sus pares, conversando, intercambiando pertenencias, cooperando.","OA2: Disfrutar de instancias de interacción social con diversas personas de la comunidad.","OA3: Colaborar en situaciones cotidianas y de juego, proponiendo acciones simples frente a necesidades que presentan sus pares.","OA4: Colaborar en actividades, conmemoraciones o celebraciones culturales de su familia y comunidad.","OA5: Iniciarse en la resolución pacífica de conflictos, dialogando respecto de la situación, escuchando, opinando y proponiendo acciones para resolver.","OA6: Manifestar disposición para practicar acuerdos de convivencia básica que regulan situaciones cotidianas y juegos.","OA7: Identificar objetos, comportamientos y situaciones de riesgo que pueden atentar contra su seguridad, bienestar y el de los demás.","OA8: Reconocer acciones correctas e incorrectas para la convivencia armónica del grupo, que se presentan en diferentes situaciones cotidianas y juegos.","OA9: Manifestar interés por algunos de sus derechos, tales como: ser escuchados, tener un nombre, jugar, entre otros.","OA10: Manifestar interés para interactuar con niños y niñas, reconociendo la diversidad de sus características y formas de vida (costumbres, fisonomía, lingüística, entre otras)."],
      transicion:["OA1: Participar en actividades y juegos colaborativos, planificando, acordando estrategias para un propósito común y asumiendo progresivamente responsabilidades en ellos.","OA2: Participar en actividades solidarias, que integran a las familias, la comunidad educativa y local.","OA3: Manifestar empatía y solidaridad frente a situaciones que vivencian sus pares, o que observa en textos o TICs, practicando acciones de escucha, apoyo y colaboración.","OA4: Apreciar el significado que tienen para las personas y las comunidades, diversas manifestaciones culturales que se desarrollan en su entorno.","OA5: Aplicar estrategias pacíficas frente a la resolución de conflictos cotidianos con otros niños y niñas.","OA6: Respetar normas y acuerdos creados colaborativamente con pares y adultos, para el bienestar del grupo.","OA7: Identificar objetos, comportamientos y situaciones de riesgo que pueden atentar contra su bienestar y seguridad, o la de los demás, proponiendo alternativas para enfrentarlas.","OA8: Comprender que algunas de sus acciones y decisiones respecto al desarrollo de juegos y proyectos colectivos, influyen en las de sus pares.","OA9: Reconocer, y progresivamente hacer respetar el derecho a expresarse libremente, a ser escuchado y a que su opinión sea tomada en cuenta.","OA10: Reconocer progresivamente requerimientos esenciales de las prácticas de convivencia democrática, tales como: escucha de opiniones divergentes, el respeto por los demás, de los turnos, de los acuerdos de las mayorías.","OA11: Apreciar la diversidad de las personas y sus formas de vida, tales como: singularidades fisonómicas, lingüísticas, religiosas, de género, entre otras."],
    },
    corporalidad: { label:"Corporalidad y Movimiento",
      sala_cuna:["OA1: Manifestar su agrado, al sentirse cómodo, seguro y contenido corporalmente.","OA2: Descubrir partes de su cuerpo y algunas de sus características físicas, a través de diversas experiencias sensoriomotrices.","OA3: Manifestar interés y satisfacción al moverse libremente en situaciones cotidianas y lúdicas.","OA4: Ampliar sus posibilidades de exploración sensoriomotriz, adquiriendo control de la prensión palmar voluntaria (toma objetos, se pasa objetos de una mano a otra, entre otros) y la postura sedente.","OA5: Adquirir desplazamiento gradual en sus distintas formas (girar, reptar, ponerse de pie, caminar), para disfrutar la ampliación de sus posibilidades de movimiento, exploración y juego.","OA6: Coordinar movimientos de manipulación ubicando objetos en relación a su propio cuerpo, tales como: acercar objetos pequeños utilizando índice y pulgar en oposición.","OA7: Explorar la alternancia de posturas y movimientos en acciones tales como: trepar, lanzar objetos o hacer ronda, adquiriendo control gradual de su cuerpo al jugar."],
      medio:["OA1: Reconocer situaciones en que se siente cómodo corporalmente, manifestando al adulto su bienestar y su interés por mantener estas condiciones.","OA2: Reconocer las principales partes, características físicas de su cuerpo y sus funciones en situaciones cotidianas y de juego.","OA3: Experimentar diversas posibilidades de acción con su cuerpo, en situaciones cotidianas y de juego, identificando progresivamente el vocabulario asociado.","OA4: Reconocer el bienestar que le produce el movimiento libre en situaciones cotidianas y lúdicas, manifestando su interés por desarrollarlo en forma frecuente.","OA5: Perfeccionar su coordinación visomotriz fina, a través del uso de diversos objetos, juguetes y utensilios.","OA6: Adquirir control y equilibrio en movimientos, posturas y desplazamientos que realiza en diferentes direcciones y en variadas situaciones cotidianas y juegos, con y sin implementos.","OA7: Resolver desafíos prácticos en situaciones cotidianas y juegos, incorporando mayor precisión y coordinación en la realización de posturas, movimientos y desplazamientos, tales como: esquivar obstáculos o mantener equilibrio al subir escalas.","OA8: Utilizar categorías de ubicación espacial y temporal, tales como: adelante/atrás, arriba/ abajo, adentro/afuera, antes/ después, rápido/lento, en situaciones cotidianas y lúdicas."],
      transicion:["OA1: Manifestar iniciativa para resguardar el autocuidado de su cuerpo y su confortabilidad, en función de su propio bienestar.","OA2: Apreciar sus características corporales, manifestando interés y cuidado por su bienestar y apariencia personal.","OA3: Tomar conciencia de su cuerpo, de algunas de sus características internas (tales como: ritmo cardíaco, de respiración), de su esquema y progresivamente de su tono corporal y lateralidad, por medio de juegos.","OA4: Comunicar nuevas posibilidades de acción logradas a través de su cuerpo en situaciones cotidianas y de juego, empleando vocabulario preciso.","OA5: Comunicar el bienestar que le produce el movimiento, al ejercitar y recrear su cuerpo en forma habitual, con y sin implementos u obstáculos.","OA6: Coordinar con precisión y eficiencia sus habilidades psicomotrices finas en función de sus intereses de exploración y juego.","OA7: Resolver desafíos prácticos manteniendo control, equilibrio y coordinación al combinar diversos movimientos, posturas y desplazamientos tales como: lanzar y recibir, desplazarse en planos inclinados, seguir ritmos, en una variedad de juegos.","OA8: Coordinar sus habilidades psicomotoras practicando posturas y movimientos de fuerza, resistencia y tracción tales como: tirar la cuerda, transportar objetos, utilizar implementos, en situaciones cotidianas y de juego.","OA9: Utilizar categorías de ubicación espacial y temporal, tales como: adelante/atrás/al lado/entre, día/noche, hoy/ mañana, antes/durante/después, en situaciones cotidianas y lúdicas."],
    },
  }},
  interaccion: { label:"Interacción y Comprensión del Entorno", nucleos: {
    entorno_natural: { label:"Exploración del Entorno Natural",
      sala_cuna:["OA1: Manifestar curiosidad y asombro por algunos elementos, situaciones y fenómenos que ocurren en su entorno natural cercano, tales como: arena, lluvia, viento, entre otros.","OA2: Reconocer algunos elementos representativos de su entorno natural, tales como: animales, plantas, ríos, cerros, desierto.","OA3: Explorar su entorno, observando, manipulando y experimentando con diversos materiales de su interés, tales como: mezclar agua con tierra, recoger hojas o ramas, trasladar piedras, hacer huellas.","OA4: Descubrir características de animales al observarlos en forma directa, en textos y en imágenes.","OA5: Colaborar en actividades sencillas de cuidado de la naturaleza, tales como: regar, recoger hojas, trasladar ramitas, entre otras."],
      medio:["OA1: Manifestar interés y asombro por diversos elementos, situaciones y fenómenos del entorno natural, explorando, observando, preguntando, describiendo, agrupando, entre otros.","OA2: Comunicar verbalmente características de elementos y paisajes de su entorno natural, tales como cuerpos celestes, cerros, desierto, flora; y de fenómenos como marejadas, sismos, tormentas, sequías.","OA3: Descubrir que el sol es fuente de luz y calor para el planeta, a través de experiencias directas o TICs.","OA4: Comunicar algunas propiedades básicas de los elementos naturales que explora, tales como: colores, texturas, tamaños, temperaturas entre otras.","OA5: Distinguir una variedad progresivamente más amplia de animales y plantas, respecto a sus características (tamaño, color, textura y morfología), sus necesidades básicas y los lugares que habitan, al observarlos en forma directa, en libros ilustrados o en TICs.","OA6: Colaborar en situaciones cotidianas, en acciones que contribuyen al desarrollo de ambientes sostenibles, tales como cerrar las llaves de agua, apagar aparatos eléctricos, entre otras.","OA7: Emplear instrumentos y herramientas de observación y recolección (lupas, frascos, recipientes, botellas, cucharas, embudos, pinzas, entre otros) en la exploración del entorno natural.","OA8: Experimentar mezclas y disoluciones con materiales cotidianos tales como: burbujas de jabón, agua salada, gelatina, describiendo los cambios observados.","OA9: Reconocer que el aire y el agua son elementos vitales para las personas, los animales y las plantas, y que estos elementos pueden encontrarse con o sin contaminación."],
      transicion:["OA1: Manifestar interés y asombro al ampliar información sobre cambios que ocurren en el entorno natural, a las personas, animales, plantas, lugares y cuerpos celestes, utilizando diversas fuentes y procedimientos.","OA2: Formular conjeturas y predicciones acerca de las causas o consecuencias de fenómenos naturales que observa, a partir de sus conocimientos y experiencias previas.","OA3: Reconocer la importancia del agua y la energía solar para la vida humana, los animales y las plantas, a partir de experiencias directas o TICs.","OA4: Comunicar propiedades básicas de los objetos y elementos naturales que explora, tales como: transparencia/opacidad, flexibilidad/rigidez, rugosidad/lisura, relacionándolos con posibles usos.","OA5: Explorar los cambios o efectos que se producen en los materiales al aplicarles fuerza, calor o agua.","OA6: Establecer relaciones de semejanzas y diferencias de animales y plantas, a partir de algunas características (tamaño, color, textura y morfología), sus necesidades básicas (formas de alimentación y abrigo), y los lugares que habitan, al observarlos en forma directa, en libros ilustrados o en TICs.","OA7: Describir semejanzas y diferencias respecto a características, necesidades básicas y cambios que ocurren en el proceso de crecimiento, en personas, animales y plantas.","OA8: Practicar algunas acciones cotidianas, que contribuyen al cuidado de ambientes sostenibles, tales como manejo de desechos en paseos al aire libre, separación de residuos, utilizar envases o papeles, plantar flores o árboles.","OA9: Comunicar sus observaciones, los instrumentos utilizados y los hallazgos obtenidos en experiencias de indagación en el entorno natural, mediante relatos, representaciones gráficas o fotografías.","OA10: Formular conjeturas a partir de los cambios observados en mezclas y disoluciones, estableciendo relaciones de posible causalidad y comunicándolas a través de diferentes medios.","OA11: Identificar las condiciones que caracterizan los ambientes saludables, tales como: aire y agua limpia, combustión natural, reciclaje, reutilización y reducción de basura, tomando conciencia progresiva de cómo estas contribuyen a su salud.","OA12: Comprender que la acción humana puede aportar al desarrollo de ambientes sostenibles y también al deterioro de estos."],
    },
    entorno_sociocultural: { label:"Comprensión del Entorno Sociocultural",
      sala_cuna:["OA1: Imitar gestos y acciones que realizan personas de su entorno cercano.","OA2: Identificar algunas actividades habituales que se realizan en su vida cotidiana, tales como: preparación de alimentos, rutinas antes de dormir, entre otras.","OA3: Manifestar interés por canciones, juegos y bailes que forman parte de su cotidianeidad.","OA4: Explorar utensilios domésticos y objetos tecnológicos que forman parte de su vida cotidiana, tales como: pocillos, envases de botellas, escobas, cucharas, teléfonos, entre otros, utilizándolos progresivamente en situaciones cotidianas y juegos.","OA5: Reconocer objetos y personas, asociándolos a ciertos lugares, tales como: educadora/ técnico y jardín infantil; mamá/papá y casa; cama y dormir, recinto de cocina y comida, de su entorno sociocultural."],
      medio:["OA1: Describir actividades habituales de su comunidad, como ir de compras, jugar en la plaza, viajar en bus, entre otras, señalando su participación en ellas.","OA2: Describir características de las formas de vida de su comunidad (viviendas, paisajes, costumbres), a través de canciones, juegos, relatos y fotos familiares, entre otras.","OA3: Seleccionar utensilios domésticos y objetos tecnológicos que les permiten resolver problemas en contextos sociales auténticos.","OA4: Reconocer sucesos significativos de su historia personal y familiar, en diversas situaciones, tales como: conversaciones familiares, relatos de un agente comunitario, visitas a lugares, observación de fotografías, entre otros.","OA5: Identificar instituciones significativas de su entorno, describiendo actividades y rutinas representativas que en ellas se realizan.","OA6: Identificar algunas normas de protección y seguridad de su entorno cotidiano referidas a alimentación, tránsito y sismos, y otras pertinentes a su contexto geográfico.","OA7: Distinguir en paisajes de su localidad, elementos naturales (bosque, cerros, ríos), y culturales (caminos, edificios, puentes)."],
      transicion:["OA1: Comprender los roles que desarrollan miembros de su familia y de su comunidad, y su aporte para el bienestar común.","OA2: Apreciar diversas formas de vida de comunidades, del país y del mundo, en el pasado y en el presente, tales como: viviendas, paisajes, alimentación, costumbres, identificando mediante diversas fuentes de documentación gráfica y audiovisual, sus características relevantes.","OA3: Comparar características de diseño, funcionamiento, utilidad, precaución de uso e impacto en el entorno, de diferentes objetos tecnológicos.","OA4: Formular interpretaciones respecto de las necesidades y situaciones que dieron origen a creaciones e inventos, tales como: refrigerador, radio, avión, naves espaciales, cámara fotográfica, entre otros.","OA5: Comunicar algunos relatos sociales sobre hechos significativos del pasado de su comunidad y país, apoyándose en recursos tales como: fotografías, videos, utensilios u objetos representativos.","OA6: Reconocer diversas acciones para el cuidado del patrimonio cultural material (construcciones, obras de carácter arqueológico, lugares) e inmaterial (tradiciones, celebraciones), de su comunidad local.","OA7: Reconocer la importancia del servicio que prestan instituciones, organizaciones, lugares y obras de interés patrimonial, tales como: escuelas, transporte público, empresas, iglesias, museos, bibliotecas, entre otros.","OA8: Conocer sobre la vida de algunas mujeres y hombres, que han realizado en el pasado y en el presente, aportes diversos en su comunidad, país, y el mundo, a través de relatos, o con apoyo de TICs.","OA9: Ampliar sus estrategias de indagación utilizando diversas fuentes, instrumentos y tecnologías de la información y comunicación, que le permitan expandir su entorno.","OA10: Comprender normas de protección y seguridad referidas a tránsito, incendios, inundaciones, sismos, y otras pertinentes a su contexto geográfico.","OA11: Identificar lugares de su entorno a través de su representación geográfica, tales como: maquetas, fotografías aéreas, dibujos y planos."],
    },
    matematico: { label:"Pensamiento Matemático",
      sala_cuna:["OA1: Adquirir la noción de permanencia de objetos y de personas significativas, mediante juegos con diversos objetos de uso cotidiano.","OA2: Explorar a través de sus experiencias sensoriales y motrices, atributos de los objetos tales como: tamaño, textura y dureza.","OA3: Experimentar con los objetos, resolviendo situaciones concretas, tales como: alcanzar objetos, apretar botones en aparatos sonoros, sacar juguetes de contenedores, juntar objetos, entre otros.","OA4: Utilizar en situaciones lúdicas, nociones de ubicación en relación con su propio cuerpo tales como: dentro/fuera; encima/debajo.","OA5: Orientarse temporalmente en situaciones cotidianas, siguiendo secuencias breves tales como: antes/después.","OA6: Emplear cuantificadores (más/menos, mucho/poco), en situaciones cotidianas."],
      medio:["OA1: Reproducir patrones sonoros, visuales, gestuales, corporales u otros, de dos o tres elementos.","OA2: Experimentar con diversos objetos, estableciendo relaciones al clasificar por dos atributos a la vez (forma, color, entre otros) y seriar por altura o longitud.","OA3: Describir la posición de objetos y personas, respecto de un punto u objeto de referencia, empleando conceptos de ubicación y distancia tales como: dentro/fuera; encima/debajo; cerca /lejos.","OA4: Orientarse temporalmente en situaciones cotidianas, mediante la utilización progresiva de algunas nociones y relaciones de secuencias, tales como: antes/ después, día/noche, hoy/mañana.","OA5: Emplear cuantificadores, tales como: más/menos, mucho/poco, todo/ninguno, al comparar cantidades de objetos en situaciones cotidianas.","OA6: Emplear progresivamente los números, para contar, identificar, cuantificar y comparar cantidades, hasta el 10 e indicar orden o posición de algunos elementos en situaciones cotidianas o juegos.","OA7: Representar progresivamente, números y cantidades en forma concreta y pictórica hasta el 10.","OA8: Resolver progresivamente problemas simples, de manera concreta y pictórica, agregando o quitando hasta 5 elementos.","OA9: Descubrir atributos de figuras 3D, mediante la exploración de objetos presentes en su entorno.","OA10: Identificar algunas acciones que se llevaron a cabo para resolver problemas."],
      transicion:["OA1: Crear patrones sonoros, visuales, gestuales, corporales u otros, de dos o tres elementos.","OA2: Experimentar con diversos objetos estableciendo relaciones al clasificar por dos o tres atributos a la vez (forma, color, tamaño, función, masa, materialidad, entre otros) y seriar por altura, ancho, longitud o capacidad para contener.","OA3: Comunicar la posición de objetos y personas respecto de un punto u objeto de referencia, empleando conceptos de ubicación (dentro/fuera; encima/debajo/entre; al frente de/detrás de); distancia (cerca/lejos) y dirección (adelante/atrás/hacia el lado), en situaciones lúdicas.","OA4: Emplear cuantificadores, tales como: “más que”, “menos que”, “igual que”, al comparar cantidades de objetos en situaciones cotidianas.","OA5: Orientarse temporalmente en situaciones cotidianas, empleando nociones y relaciones de secuencia (antes/ahora/después/al mismo tiempo, día/noche), frecuencia (siempre/a veces/ nunca) y duración (larga/corta).","OA6: Emplear los números, para contar, identificar, cuantificar y comparar cantidades hasta el 20 e indicar orden o posición de algunos elementos en situaciones cotidianas o juegos.","OA7: Representar números y cantidades hasta el 10, en forma concreta, pictórica y simbólica.","OA8: Resolver problemas simples de manera concreta y pictórica agregando o quitando hasta 10 elementos, comunicando las acciones llevadas a cabo.","OA9: Representar objetos desde arriba, del lado, abajo, a través de dibujos, fotografías o TICs, formulando conjeturas frente a sus descubrimientos.","OA10: Identificar atributos de figuras 2D y 3D, tales como: forma, cantidad de lados, vértices, caras, que observa en forma directa o a través de TICs.","OA11: Emplear medidas no estandarizadas, para determinar longitud de objetos, registrando datos, en diversas situaciones lúdicas o actividades cotidianas.","OA12: Comunicar el proceso desarrollado en la resolución de problemas concretos, identificando la pregunta, acciones y posibles respuestas."],
    },
  }},
};
...
function catalogoOAporNivel(nivel) {
  let out = "";
  for (const [ambKey, ambData] of Object.entries(OAS)) {
    out += `\nÁMBITO: ${ambData.label}\n`;
    for (const [nucKey, nucData] of Object.entries(ambData.nucleos)) {
      const lista = nucData[nivel] || nucData.medio || [];
      out += `  Núcleo "${nucData.label}":\n`;
      lista.forEach(oa => {
        const num = (oa.match(/^OA(\d+):/) || [])[1] || "";
        out += `    - [codigo: ${ambKey}.${nucKey}.${num}] ${oa}\n`;
      });
    }
  }
  return out.trim();
...
function catalogoOATporNivel(nivel) {
  ...
  for (const [nucKey, nucData] of Object.entries(amb.nucleos)) {
    const lista = nucData[nivel] || nucData.medio || [];
    out += `  Núcleo "${nucData.label}":\n`;
    lista.forEach(oa => {
      const num = (oa.match(/^OA(\d+):/) || [])[1] || "";
      out += `    - [codigo: ${nucKey}.${num}] ${oa}\n`;
    });
  }
  return out.trim();
}
...
function printPlan(plan, meta) {
  ...
  const bodyHtml = `
    ...
    <div class="section">
      ...
      ${plan.oa_especificado ? `<div style="margin-top:8px;font-size:13px"><strong>OA Especificado:</strong><br>${plan.oa_especificado}</div>` : ""}
    </div>
    <div class="section">
...
{"ideas":[{"titulo":"...","desarrollo":"..."},{"titulo":"...","desarrollo":"..."},{"titulo":"...","desarrollo":"..."},{"titulo":"...","desarrollo":"..."},{"titulo":"...","desarrollo":"..."}]}`;
  ...
  const generarSecuencia = useCallback(async (ideaSel, objetivosPersonalizados = null) => {
    ...
    const instruccionObjetivos = (objetivosPersonalizados && objetivosPersonalizados.length > 0)
      ? `- Usa EXACTAMENTE los objetivos indicados en "OBJETIVOS OBLIGATORIOS POR DÍA": para cada día están dados el OA y el OAT. NO los escribas en el JSON (la aplicación los insertará tal cual): tu única tarea sobre ellos es redactar el "oa_especificado" adaptando el OA dado al tema del día.`
      : `- Para CADA día elige DOS objetivos: (a) un OA del CATÁLOGO OFICIAL DE OA (puede ser de cualquier ámbito), y (b) un OAT del CATÁLOGO OFICIAL DE OAT (siempre del ámbito Desarrollo Personal y Social). En el JSON entrega ÚNICAMENTE sus códigos, en "oa_codigo" y "oat_codigo", copiados de los corchetes [codigo: ...] de los catálogos. NO escribas el texto de los objetivos ni el ámbito ni el núcleo: la aplicación insertará el texto oficial literal del BCEP a partir de cada código. NO uses códigos que no aparezcan en los catálogos de este nivel. AMBOS códigos son obligatorios en todos los días.`;
...
Para CADA UNO de los ${ideaDias} días, sin excepción (si falta alguno, la planificación es inválida):
  1. "oa_codigo": el código del OA elegido, copiado tal cual de los corchetes del catálogo de OA (ej: desarrollo.identidad.3). El texto oficial lo inserta la aplicación; tú NUNCA redactas ni reproduces el texto del OA.
  2. "oa_especificado": el texto del OA elegido adaptado al tema puntual del día. Ejemplo real del formato: si el OA oficial es "Reconocer las principales partes, características físicas de su cuerpo y sus funciones en situaciones cotidianas y de juego" y el día trata sobre la boca, el especificado es "Reconocer las principales partes, características físicas de la boca en situaciones cotidianas y de juego". Mantén la redacción del OA oficial y solo enfócala al contenido del día.
  3. "oat_codigo": el código del OAT elegido, copiado tal cual de los corchetes del CATÁLOGO OFICIAL DE OAT (ej: identidad.4). El OAT SIEMPRE pertenece al ámbito "Desarrollo Personal y Social". NUNCA dejes este campo vacío. Cada día debe tener su OAT, complementario al OA de ese día.
...
Responde SOLO con JSON válido, sin markdown ni backticks, con esta estructura EXACTA:
{
  ...
  "dias": [
    {
      "dia": 1,
      "oa_codigo": "código del OA elegido tal como aparece en el catálogo (ej: desarrollo.identidad.3)",
      "oa_especificado": "el OA adaptado al tema puntual de este día",
      "oat_codigo": "código del OAT elegido tal como aparece en el catálogo de transversales (ej: identidad.4)",
...
Genera los ${ideaDias} días completos.`;
    ...
    try {
      ...
      // ── Anti-alucinación: la IA solo entrega códigos; el texto de OA/OAT se inserta
      // SIEMPRE desde el catálogo literal del BCEP 2018 (nunca desde la respuesta de la IA).
      const normalizar = (s) => String(s || "").toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").replace(/[^a-z0-9\s]/g, " ").split(/\s+/).filter(w => w.length > 3);
      const similitud = (a, b) => {
      ...
      const resolverOA = (codigo) => {
        const m = String(codigo || "").match(/([a-z_]+)[.\s|/-]+([a-z_]+)[.\s|/-]+(\d+)/i);
        if (!m) return null;
        const amb = OAS[m[1].toLowerCase()]; const nuc = amb?.nucleos?.[m[2].toLowerCase()];
        const lista = nuc?.[ideaNivel] || [];
        const oa = lista.find(t => t.startsWith(`OA${m[3]}:`));
        return oa ? { ambito: amb.label, nucleo: nuc.label, oa } : null;
      };
      const resolverOAT = (codigo) => {
        const m = String(codigo || "").match(/([a-z_]+)[.\s|/-]+(\d+)/i);
        if (!m) return null;
        const lista = OAS.desarrollo.nucleos[m[1].toLowerCase()]?.[ideaNivel] || [];
        return lista.find(t => t.startsWith(`OA${m[2]}:`)) || null;
      };
      // Respaldo: si la IA entregó texto en vez de código, se ancla al OA oficial más parecido
      const snapOA = (texto) => {
        if (!texto) return null;
        let mejor = null, score = 0;
        for (const [, ambData] of Object.entries(OAS)) {
          for (const [, nucData] of Object.entries(ambData.nucleos)) {
            for (const oa of (nucData[ideaNivel] || [])) {
              const s = similitud(texto, oa);
              if (s > score) { score = s; mejor = { ambito: ambData.label, nucleo: nucData.label, oa }; }
            }
          }
        }
        return score >= 0.3 ? mejor : null;
      };
      const snapOAT = (texto) => {
        if (!texto) return null;
        let mejor = null, score = 0;
        for (const [, nucData] of Object.entries(OAS.desarrollo.nucleos)) {
          for (const oa of (nucData[ideaNivel] || [])) {
            const s = similitud(texto, oa);
            if (s > score) { score = s; mejor = oa; }
          }
        }
        return score >= 0.3 ? mejor : null;
      };
      ...
      parsed.dias = parsed.dias.map((d, i) => {
        ...
        if (objetivosPersonalizados && objetivosPersonalizados[i]) {
          // Modo personalizado: forzar exactamente lo elegido por la educadora (texto oficial del catálogo)
          const o = objetivosPersonalizados[i];
          dia.ambito = OAS[o.ambito]?.label || dia.ambito || "";
          dia.nucleo = OAS[o.ambito]?.nucleos[o.nucleo]?.label || dia.nucleo || "";
          dia.oa = o.oa || dia.oa || "";
          dia.oat = o.oat || dia.oat || "";
        } else {
          // Modo rápido: resolver códigos al texto literal; si el código falla, anclar por similitud
          const r = resolverOA(dia.oa_codigo) || snapOA(dia.oa) || snapOA(dia.oa_especificado);
          if (r) { dia.ambito = r.ambito; dia.nucleo = r.nucleo; dia.oa = r.oa; }
          const t = resolverOAT(dia.oat_codigo) || snapOAT(dia.oat);
          if (t) dia.oat = t;
        }
...
OBJETIVOS (definidos por la educadora — NO los reescribas ni los reproduzcas en el JSON; la aplicación insertará su texto oficial literal):
- OA Principal (oficial): ${oa || "seleccionar el más pertinente"}
- Ámbito Transversal: Desarrollo Personal y Social / Núcleo: ${nucleoOatLabel}
- OAT (oficial): ${oat || "seleccionar el más pertinente"}
Tu única tarea sobre el OA es redactar "oa_especificado": el mismo OA oficial adaptado al tema puntual de la actividad, manteniendo su redacción y solo enfocándolo al contenido (ej.: si el OA es "Reconocer las principales partes... de su cuerpo..." y la actividad trata sobre la boca, el especificado es "Reconocer las principales partes... de la boca...").
...
{"titulo":"título creativo","descripcion":"2 oraciones","oa_especificado":"el OA oficial adaptado al tema puntual de la actividad","principios":"lista separada por comas","inicio":"inicio detallado 3-4 oraciones","desarrollo":"desarrollo detallado 5-6 oraciones","cierre":"cierre detallado 3-4 oraciones","recursos":"materiales separados por comas","preguntas":["p1","p2","p3"],"focos":["f1","f2"],"evaluacion":"proceso evaluativo"${dua?',"dua_compromiso":"...","dua_representacion":"...","dua_accion":"..."':''}}`;
    ...
    try {
      ...
      if (start === -1 || end === -1) throw new Error("No se recibió JSON válido de la IA.");
      const parsed = JSON.parse(txt.slice(start, end + 1));
      // Anti-alucinación: el OA y OAT mostrados son SIEMPRE los oficiales elegidos por la educadora,
      // nunca el texto que devuelva la IA. Esta solo aporta la versión especificada al tema.
      parsed.oa_texto = oa || parsed.oa_texto || "";
      parsed.oat_texto = oat || parsed.oat_texto || "";
      setPlan(parsed);
    } catch(e) {
          ...
          <>
            ...
            {[
              ...
              ["Objetivo de Aprendizaje (OA)", (
                <>
                  <div style={{display:"inline-block",background:pinkLight,color:"#72243E",padding:"5px 12px",borderRadius:6,fontSize:13,border:`0.5px solid ${pinkBorder}`}}>{plan.oa_texto}</div>
                  {plan.oa_especificado && (
                    <div style={{marginTop:8}}>
                      <div style={{fontSize:12,fontWeight:600,color:"#72243E",marginBottom:2}}>OA Especificado:</div>
                      <div style={{fontSize:13,color:"#72243E",fontStyle:"italic"}}>{plan.oa_especificado}</div>
                    </div>
                  )}
                </>
              )],
